...
public class ClaudeSDKToolWindow implements ToolWindowFactory, DumbAware {
    ...
    public static final String TOOL_WINDOW_ID = "CCXG";
    ...
    private static void cleanupWindowProcesses(@NotNull ClaudeChatWindow window) {
        try {
            ...
            if (window.getCliBridges() != null) {
                for (com.github.ccxgui.provider.common.MarkerCliBridge bridge
        ...
        if (PlatformUtils.isPluginDevMode()) {
            com.intellij.openapi.actionSystem.AnAction devToolsAction =
                    com.intellij.openapi.actionSystem.ActionManager.getInstance()
                            .getAction("CCXGUI.OpenDevToolsAction");
    ...
    private JPanel createLoadingPanel() {
        ...
        panel.setBackground(com.github.ccxgui.util.ThemeConfigService.getBackgroundColor());
