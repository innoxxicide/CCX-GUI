...
public class ErrorPanelBuilder {
    ...
    public static JPanel build(String title, String message, String currentNodePath, Consumer<String> onSaveAndRetry) {
        ...
        JLabel nodeLabel = new JLabel(com.github.ccxgui.i18n.ClaudeCodeGuiBundle.message("error.nodePathLabel"));
        ...
        JButton saveAndRetryButton = new JButton(com.github.ccxgui.i18n.ClaudeCodeGuiBundle.message("error.saveButton"));
