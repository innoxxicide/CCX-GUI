package com.github.ccxgui.handler.context;
        ...
        if (JAVA_PLUGIN_AVAILABLE) {
            try {
                Class<?> javaCollectorClass = Class.forName(
                    "com.github.ccxgui.handler.context.JavaContextCollector");
        ...
        if (PYTHON_PLUGIN_AVAILABLE) {
            try {
                Class<?> pythonCollectorClass = Class.forName(
                    "com.github.ccxgui.handler.context.PythonContextCollector");
