    ...
    public void handleSetMode(String content) {
        try {
            ...
            if (this.context.getSession() != null) {
                ...
                com.github.ccxgui.notifications.ClaudeNotifier.setMode(this.context.getProject(), mode);
    ...
    private void pushPermissionModeLive(String mode) {
        try {
            ...
            if (provider == null || provider.isEmpty()) {
                provider = com.github.ccxgui.handler.core.HandlerContext.DEFAULT_PROVIDER;
            }
