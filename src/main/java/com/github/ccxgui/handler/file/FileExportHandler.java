...
public class FileExportHandler extends BaseMessageHandler {
    ...
    public boolean handle(String type, String content) {
        if ("save_markdown".equals(type)) {
            ...
            handleSaveFile(content, ".md", com.github.ccxgui.i18n.ClaudeCodeGuiBundle.message("file.saveMarkdownDialog"));
            return true;
        } else if ("save_json".equals(type)) {
            LOG.info("[FileExportHandler] 处理: save_json");
            handleSaveFile(content, ".json", com.github.ccxgui.i18n.ClaudeCodeGuiBundle.message("file.saveJsonDialog"));
            return true;
        }
        return false;
    }
    ...
    private void writeFileAsync(File fileToSave, String content) {
        CompletableFuture.runAsync(() -> {
            try (FileWriter writer = new FileWriter(fileToSave, StandardCharsets.UTF_8)) {
                ...
                notifySuccess(com.github.ccxgui.i18n.ClaudeCodeGuiBundle.message("file.saved"));
            } catch (IOException e) {
                LOG.error("[FileExportHandler] 保存文件失败: " + e.getMessage(), e);
                String errorDetail = e.getMessage() != null ? e.getMessage() : com.github.ccxgui.i18n.ClaudeCodeGuiBundle.message("file.saveFailed");
                notifyError(com.github.ccxgui.i18n.ClaudeCodeGuiBundle.message("file.saveFailedWithReason", errorDetail));
            }
        });
    }
    ...
    private void notifyError(String message) {
        ApplicationManager.getApplication().invokeLater(() -> {
            String errorDetail = message != null ? message : com.github.ccxgui.i18n.ClaudeCodeGuiBundle.message("file.unknownError");
            String errorMsg = escapeJs(com.github.ccxgui.i18n.ClaudeCodeGuiBundle.message("file.saveFailedWithReason", errorDetail));
            String jsCode = "if (window.addToast) { " +
