...
public class CodexProviderOperations {
    ...
    public void handleAddCodexProvider(String content) {
        try {
            ...
            ApplicationManager.getApplication().invokeLater(() -> {
                context.callJavaScript("window.showError", context.escapeJs(com.github.ccxgui.i18n.ClaudeCodeGuiBundle.message("provider.addCodexFailed", e.getMessage())));
            });
        }
    }
    ...
    public void handleUpdateCodexProvider(String content) {
        try {
            ...
            ApplicationManager.getApplication().invokeLater(() -> {
                context.callJavaScript("window.showError", context.escapeJs(com.github.ccxgui.i18n.ClaudeCodeGuiBundle.message("provider.updateCodexFailed", e.getMessage())));
            });
        }
    }
    ...
    public void handleDeleteCodexProvider(String content) {
        ...
        try {
            ...
            if (!data.has("id")) {
                ...
                ApplicationManager.getApplication().invokeLater(() -> {
                    context.callJavaScript("window.showError", context.escapeJs(com.github.ccxgui.i18n.ClaudeCodeGuiBundle.message("provider.deleteCodexMissingId")));
                });
                return;
            }
            ...
            ApplicationManager.getApplication().invokeLater(() -> {
                context.callJavaScript("window.showError", context.escapeJs(com.github.ccxgui.i18n.ClaudeCodeGuiBundle.message("provider.deleteCodexFailed", e.getMessage())));
            });
        }
    ...
    private void invalidateCodexQuotaCache() {
        try {
            ApplicationManager.getApplication()
                    .getService(com.github.ccxgui.service.CodexSubscriptionQuotaService.class)
                    .invalidateCache();
        } catch (Exception e) {
    ...
    public void handleSwitchCodexProvider(String content) {
        try {
            ...
            if (com.github.ccxgui.settings.CodexProviderManager.CODEX_CLI_LOGIN_PROVIDER_ID.equals(id)) {
            ...
            ApplicationManager.getApplication().invokeLater(() -> {
                String successMsg = com.github.ccxgui.i18n.ClaudeCodeGuiBundle.message("toast.providerSwitchSuccess")
                        + com.github.ccxgui.i18n.ClaudeCodeGuiBundle.message("provider.switchSyncCodex");
    ...
    public void handleRevokeCodexLocalConfigAuthorization(String content) {
        try {
            ...
            boolean wasCliLoginActive = activeProvider != null
                    && activeProvider.has("id")
                    && com.github.ccxgui.settings.CodexProviderManager.CODEX_CLI_LOGIN_PROVIDER_ID
            ...
            ApplicationManager.getApplication().invokeLater(() -> {
                context.callJavaScript("window.showSwitchSuccess", context.escapeJs(
                        com.github.ccxgui.i18n.ClaudeCodeGuiBundle.message("toast.codexLocalConfigAuthorizationRevoked")));
            ...
            ApplicationManager.getApplication().invokeLater(() -> {
                context.callJavaScript("window.showError", context.escapeJs(
                        com.github.ccxgui.i18n.ClaudeCodeGuiBundle.message("toast.providerSwitchFailed") + ": " + e.getMessage()));
            });
        }
    }
    ...
    private void handleSwitchToCodexCliLogin() {
        try {
            ...
            ApplicationManager.getApplication().invokeLater(() -> {
                context.callJavaScript("window.showSwitchSuccess", context.escapeJs(
                        com.github.ccxgui.i18n.ClaudeCodeGuiBundle.message("toast.codexCliLoginSwitchSuccess")));
                handleGetCodexProviders();
                handleGetCurrentCodexConfig();
                handleGetActiveCodexProvider();
            });
