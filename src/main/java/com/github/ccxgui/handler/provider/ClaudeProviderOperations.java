...
import com.github.ccxgui.settings.ProviderManager;

import com.github.ccxgui.model.DeleteResult;
...
public class ClaudeProviderOperations {
    ...
    public void handleAddProvider(String content) {
        try {
            ...
            ApplicationManager.getApplication().invokeLater(() -> {
                context.callJavaScript("window.showError", context.escapeJs(com.github.ccxgui.i18n.ClaudeCodeGuiBundle.message("provider.addFailed", e.getMessage())));
            });
        }
    }
    ...
    public void handleUpdateProvider(String content) {
        try {
            ...
            ApplicationManager.getApplication().invokeLater(() -> {
                context.callJavaScript("window.showError", context.escapeJs(com.github.ccxgui.i18n.ClaudeCodeGuiBundle.message("provider.updateFailed", e.getMessage())));
            });
        }
    }
    ...
    public void handleDeleteProvider(String content) {
        ...
        try {
            ...
            if (!data.has("id")) {
                ...
                ApplicationManager.getApplication().invokeLater(() -> {
                    context.callJavaScript("window.showError", context.escapeJs(com.github.ccxgui.i18n.ClaudeCodeGuiBundle.message("provider.deleteMissingId")));
                });
                return;
            }
            ...
            ApplicationManager.getApplication().invokeLater(() -> {
                context.callJavaScript("window.showError", context.escapeJs(com.github.ccxgui.i18n.ClaudeCodeGuiBundle.message("provider.deleteFailed", e.getMessage())));
            });
        }
        ...
        try {
            ...
            if (ProviderManager.DISABLED_PROVIDER_ID.equals(id)) {
                ...
                ApplicationManager.getApplication().invokeLater(() -> {
                    context.callJavaScript("window.showSwitchSuccess",
                            context.escapeJs(com.github.ccxgui.i18n.ClaudeCodeGuiBundle.message("toast.providerDisabled")));
                    handleGetProviders();
            ...
            if (ProviderManager.LOCAL_SETTINGS_PROVIDER_ID.equals(id)) {
                ...
                if (!Files.exists(settingsPath)) {
                    ...
                    ApplicationManager.getApplication().invokeLater(() -> {
                        context.callJavaScript("window.showError",
                                context.escapeJs(com.github.ccxgui.i18n.ClaudeCodeGuiBundle.message("error.localProviderSettingsNotFound")));
                    });
                    return;
                }
                ...
                try {
                    ...
                    ApplicationManager.getApplication().invokeLater(() -> {
                        context.callJavaScript("window.showError",
                                context.escapeJs(com.github.ccxgui.i18n.ClaudeCodeGuiBundle.message("error.localProviderInvalidJson", e.getMessage())));
                    });
                    return;
                }
                ...
                ApplicationManager.getApplication().invokeLater(() -> {
                    context.callJavaScript("window.showSwitchSuccess",
                            context.escapeJs(com.github.ccxgui.i18n.ClaudeCodeGuiBundle.message("toast.localProviderSwitchSuccess")));
                    handleGetProviders();
                    handleGetActiveProvider();
                });
                return;
            ...
            if (ProviderManager.CLI_LOGIN_PROVIDER_ID.equals(id)) {
                ...
                ApplicationManager.getApplication().invokeLater(() -> {
                    context.callJavaScript("window.showSwitchSuccess",
                            context.escapeJs(com.github.ccxgui.i18n.ClaudeCodeGuiBundle.message("toast.cliLoginSwitchSuccess")));
                    handleGetProviders();
                    handleGetActiveProvider();
            ...
            ApplicationManager.getApplication().invokeLater(() -> {
                String successMsg = com.github.ccxgui.i18n.ClaudeCodeGuiBundle.message("toast.providerSwitchSuccess")
                        + com.github.ccxgui.i18n.ClaudeCodeGuiBundle.message("provider.switchSyncClaude");
            ...
            ApplicationManager.getApplication().invokeLater(() -> {
                context.callJavaScript("window.showError", context.escapeJs(com.github.ccxgui.i18n.ClaudeCodeGuiBundle.message("toast.providerSwitchFailed") + ": " + e.getMessage()));
            });
        }
    }
