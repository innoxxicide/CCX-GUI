        ...
        try {
            ...
            if (agentId != null) {
                ...
                if (agent != null) {
                    ...
                    com.github.ccxgui.notifications.ClaudeNotifier.setAgent(context.getProject(), agentName);
                } else {
                    com.github.ccxgui.notifications.ClaudeNotifier.setAgent(context.getProject(), "");
                }
            } else {
                com.github.ccxgui.notifications.ClaudeNotifier.setAgent(context.getProject(), "");
            }
    ...
    private void handleExportAgents(String content) {
        ApplicationManager.getApplication().invokeLater(() -> {
            try {
                ...
                com.github.ccxgui.notifications.ClaudeNotifier.showError(
                        context.getProject(),
