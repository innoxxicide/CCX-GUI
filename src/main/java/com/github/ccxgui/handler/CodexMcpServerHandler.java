...
import com.github.ccxgui.settings.CodexMcpServerManager;
...
public class CodexMcpServerHandler extends BaseMessageHandler {
    ...
    private void handleGetMcpServerTools(String content) {
        try {
            if (!isCodexLocalConfigAuthorized()) {
                Gson gson = new Gson();
                sendToolsError("", com.github.ccxgui.i18n.ClaudeCodeGuiBundle.message("error.codexLocalAccessNotAuthorized"), gson);
                return;
            }
