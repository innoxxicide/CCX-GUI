...
public class GrokMessageHandler implements MessageCallback {
    ...
    private void handleUsage(String content) {
        ...
        try {
            ...
            JsonObject canonical = com.github.ccxgui.provider.grok.GrokContextUsageBuilder
            ...
            int used = com.github.ccxgui.provider.grok.GrokContextUsageBuilder.extractUsedTokens(storedUsage);
            if (used > 0) {
                int maxTokens = com.github.ccxgui.handler.provider.ModelProviderHandler
            ...
            try {
                ...
                if (sid != null && !sid.isBlank()) {
                    new com.github.ccxgui.provider.grok.GrokUsageLedger().record(
                            sid,
                            state.getModel(),
                            null,
                            storedUsage
    ...
    private void pushContextUsageFromCurrentAssistant() {
        ...
        int used = com.github.ccxgui.provider.grok.GrokContextUsageBuilder.extractUsedTokens(usage);
        if (used <= 0) {
            return;
        }
        int maxTokens = com.github.ccxgui.handler.provider.ModelProviderHandler
