...
public class GrokSDKBridgeTest {
    ...
    public void grokMessageHandlerUsageUsesRealContextLimit() {
        ...
        int limit = com.github.ccxgui.handler.provider.ModelProviderHandler.getModelContextLimit("grok-2");
        assertTrue(limit > 0);
    ...
    public void testGrokModelsHaveExpectedContextLimits() {
        assertEquals(500000, com.github.ccxgui.handler.provider.ModelProviderHandler.getModelContextLimit("grok"));
        assertEquals(128000, com.github.ccxgui.handler.provider.ModelProviderHandler.getModelContextLimit("grok-2"));
        assertEquals(500000, com.github.ccxgui.handler.provider.ModelProviderHandler.getModelContextLimit("grok-4.6"));
        assertEquals(500000, com.github.ccxgui.handler.provider.ModelProviderHandler.getModelContextLimit("grok-build"));
    }
}