package com.github.ccxgui.action.editor;
...
public class PluginActionRegistrationTest {
    ...
    public void copySelectionReferenceActionAppearsInEditorPopupMenuAfterSendSelectionAction() throws Exception {
        ...
        Assert.assertEquals(
                "com.github.ccxgui.action.editor.CopySelectionReferenceAction",
                action.actionClass
        );
    ...
    public void editorPopupActionsUseExpectedIcons() throws Exception {
        ...
        Assert.assertEquals("/icons/ccx-gui-icon.svg", quickFixAction.icon);
    }
    ...
    public void sessionTemplateActionsAreRegistered() throws Exception {
        ...
        Assert.assertEquals("com.github.ccxgui.action.SaveAsTemplateAction", saveAsTemplateAction.actionClass);
        Assert.assertEquals("com.github.ccxgui.action.CreateFromTemplateAction", createFromTemplateAction.actionClass);
    }
    ...
    public void pluginDeclaresJcefAndUsesStableTemplateActionIcon() throws Exception {
        ...
        ActionRegistration saveAsTemplateAction = getActionRegistration("CCXGUI.SaveAsTemplateAction");
        Assert.assertEquals("/icons/ccx-gui-icon.svg", saveAsTemplateAction.icon);
    }
