...
describe('TaskExecutionBlock polling', () => {
  ...
  it('renders task_event usage in SubagentProcessDetails for a completed async agent', () => {
    ...
    // SubagentProcessDetails formats via toLocaleString(), so the thousands
    // separator follows the host locale ("4,200" on en-US, "4 200" on uk-UA).
    // Format the expectation the same way instead of hardcoding en-US.
    expect(stats?.textContent).toContain((4200).toLocaleString());
