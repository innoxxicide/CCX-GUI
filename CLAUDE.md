...
**CCX GUI (Claude or Codex)** — an IntelliJ IDEA plugin (currently v0.0.4) that gives Claude Code and OpenAI Codex a visual interface inside the IDE. It is a three-layer system, and almost every non-trivial change crosses at least two of the layers:
